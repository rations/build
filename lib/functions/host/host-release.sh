...
function obtain_and_check_host_release_and_arch() {
	...
	if [[ -z $HOSTRELEASE || "bookworm trixie forky sid daedalus excalibur jammy kinetic lunar vanessa vera victoria virginia wilma mantic noble resolute" != *"$HOSTRELEASE"* ]]; then
